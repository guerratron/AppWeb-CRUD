...
> -----------------------------------------------------------------------------------------------------  
>   [![logo](./logo.png "Página de prueba")](https://guerratron.kesug.com/ "Página de prueba")  
> '**PHP+MySQL**' (PHP Web-APP) &emsp;-&emsp; Formulario de suscripciones ficticias con PHP+MySQL.  
...
> Versión: 1.0.0  
> Proyect:    PHP+MySQL Javascript &emsp; Package: Suscribe.zip &emsp; Main Class: registro.php  
> 
> ----------------------------------------------------------------------------------------------------  
...
- [📋 Introducción](#📋-intro)
- [〽️ Características](#〽️-caracteristicas)
...
# <img class="logo" src="./favicon.ico" title="logo" /> PHP+MySQL Web-App v1.0 <span class="small">by [GuerraTron-25][authorEmail]</span>

## 📋-Intro
*Portal-Web* con formulario de suscripciones ficticias con *PHP+MySQL*.  
...
Se trata de una *web ficticia* que tiene un formulario de envío de suscripciones a una supuesta **newsletter**. *PHP* controla la parte de conexionado con la **Base de Datos** y sus consultas, para mostrar a través de diferentes páginas html una salida exitosa o no.


<p class="alert orange">ATENCIÓN: Al ser una app-web, cada refresco hará que se pierdan los datos introducidos en los formularios, hay que tenerlo en cuenta para no perder datos. Además, si se ha pulsado algún botón de envío, al refrescar se volverán a enviar los datos pudiendo provocar una duplicidad en la Base de Datos.<br />
Mejor moverse a través de los enlaces que aparecen, o a través del 'breadcrumbs'</p>
